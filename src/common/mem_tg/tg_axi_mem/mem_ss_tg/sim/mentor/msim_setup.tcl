...
# ----------------------------------------
# If mem_ss_tg is one of several IP cores in your
...
# ----------------------------------------
# ACDS 21.4 67 linux 2022.02.10.15:21:20
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "mem_ss_tg.mem_ss_tg"
}
...
if ![info exists QUARTUS_INSTALL_DIR] { 
  set QUARTUS_INSTALL_DIR "/nfs/site/disks/pac_release_1/acds_ac/quartus_21.4_b67_pcie_hssi_patch_only/acds/quartus/"
}
...
set LD_LIBRARY_PATH [dict merge $LD_LIBRARY_PATH [dict get [mem_ss_tg::get_env_variables $SIMULATOR_TOOL_BITNESS] "LD_LIBRARY_PATH"]]
if {[dict size $LD_LIBRARY_PATH] !=0 } {
  set LD_LIBRARY_PATH [subst [join [dict keys $LD_LIBRARY_PATH] ":"]]
  setenv LD_LIBRARY_PATH "$LD_LIBRARY_PATH"
}
append ELAB_OPTIONS [subst [mem_ss_tg::get_elab_options $SIMULATOR_TOOL_BITNESS]]
append SIM_OPTIONS [subst [mem_ss_tg::get_sim_options $SIMULATOR_TOOL_BITNESS]]
...
alias file_copy {
  ...
  set memory_files [concat $memory_files [mem_ss_tg::get_memory_files "$QSYS_SIMDIR"]]
...
set logical_libraries [list "work" "work_lib" "altera_ver" "lpm_ver" "sgate_ver" "altera_mf_ver" "altera_lnsim_ver" "tennm_ver" "tennm_hssi_ver" "tennm_hssi_e0_ver" "tennm_hssi_p0_ver"]
...
set design_libraries [dict merge $design_libraries [mem_ss_tg::get_design_libraries]]
...
alias com {
  ...
  set design_files [dict merge [mem_ss_tg::get_common_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR"]]
  set common_design_files [dict values $design_files]
  foreach file $common_design_files {
    eval $file
  }
  set design_files [list]
  set design_files [concat $design_files [mem_ss_tg::get_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR"]]
