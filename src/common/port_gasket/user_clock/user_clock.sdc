...
# Workaround for user clk reconfig path                                                                                                                                                                                              
set_false_path -from [get_keepers {*|qph_user_clk|qph_user_clk_iopll|iopll_0|tennm_pll~pll_ctrl_reg}] -to [get_keepers {*|qph_user_clk|qph_user_clk_rcfg_fsm|*}]
