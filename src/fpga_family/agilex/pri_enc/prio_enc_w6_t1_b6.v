...
// This file was generated 08/04/2020 17:24:41

// This is a small one.  building it from simple LUTs

//   output is offset +6
module prio_enc_w6_t1_b6 #(
...
generate
    if (SIM_EMULATE) begin
        wire [63:0] local_mask = 64'heeefeeefeeefeeef;
        wire [5:0] local_din = {din[5],din[4],din[3],din[2],din[1],din[0]};
...
generate
    if (SIM_EMULATE) begin
        wire [63:0] local_mask = 64'heeeeeeeeeeeeeeef;
        wire [5:0] local_din = {din[5],din[4],din[3],din[2],din[1],din[0]};
...
generate
    if (SIM_EMULATE) begin
        wire [63:0] local_mask = 64'h1111111111111111;
        wire [5:0] local_din = {din[5],din[4],din[3],din[2],din[1],din[0]};
