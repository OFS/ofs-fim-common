...
proc emit_ip_cfg {ofile_name ip_name} {
    ...
    for {set clk_num 0} {$clk_num < $n_clocks} {incr clk_num} {
        ...
        if { $mhz > 0 } {
            ...
            puts $of "`define OFS_FIM_IP_CFG_${ip_name}_CLK${clk_num}_MHZ      $mhz"
            puts $of "`define OFS_FIM_IP_CFG_${ip_name}_CLK${clk_num}_MHZ_INT  [expr round($mhz)]  // Nearest integer frequency"
            puts $of ""
        }
    }
