...
## ********************************************************
##  Unlike the OFS build_setup and build_finish scripts,
##  there are no OFS_PRE_COMPILE_SCRIPT or OFS_POST_COMPILE_SCRIPT
##  hooks. OFS scripted compilation must remain equivalent
##  to compilation in the Quartus GUI or with quartus_sh
##  flows. Invoking hooks from the shell would break that
##  contract.
##
##  Use Quartus pre- and post-module script files instead.
## ********************************************************
