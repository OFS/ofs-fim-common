...
class PCIe(OFS):
    ...
    def __init__(self, ofs_config, pcie_config, target):
        ...
        self.PCIE_SS_PARAM = SourceFileLoader(
            "pcie_ss_component_parameters", pcie_default_path
        ).load_module()
    ...
    def process_pfs(self, pf):
        ...
        self.ip_component_params[f"core16_{pf}_subsys_dev_id_hwtcl"] = self.device_id
        self.ip_component_params[f"core16_exvf_subsysid_{pf}"] = self.device_id
